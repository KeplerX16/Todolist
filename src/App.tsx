...
function App() {
  ...
  return (
    <>
      <div className='bg-blue-100 max-h-screen max-w-screen w-screen h-screen'>
        <h1 className='text-2xl bg-blue-300 w-screen p-4 justify-center font-bold flex text-white'>To-do List</h1>
